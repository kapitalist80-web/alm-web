...
GOV_BOND_DURATION_RESET_ENABLED = {bool(params.get("GOV_BOND_DURATION_RESET_ENABLED", False))}
...
CORP_BOND_DURATION_RESET_ENABLED = {bool(params.get("CORP_BOND_DURATION_RESET_ENABLED", True))}
...
DURATION_RESET_ENABLED = GOV_BOND_DURATION_RESET_ENABLED
